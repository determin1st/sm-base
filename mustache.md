...
<details><summary>null's author (Tony Hoare) about null</summary>

> if you want to avoid using null then you have to invent a whole sort of sub-language for initializing
- https://youtu.be/YYkOWzrO3xg

sub-language here is a bits of php code
that stuff your data with flags and
summaries determined over that data;
i call them helper routines or
render helpers or simply helpers.
</details>
